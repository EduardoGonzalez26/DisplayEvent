...
/* ------------------------------------------------------------------
   Ubicaciones minimalistas (Boda Jorge & Macarena): tarjetas sin fondo
   pesado con borde naranja, numeración romana en script rosa, nombre
   serif verde y botones primarios naranja (texto marfil) + secundarios
   con borde naranja/amarillo. Reutiliza la lógica de URLs seguras de
   shared/Locations (mismo filtro y paridad de null).
------------------------------------------------------------------ */
