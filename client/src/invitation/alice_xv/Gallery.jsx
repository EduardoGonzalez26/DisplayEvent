...
/* ------------------------------------------------------------------
   Galería (XV de Alice): sección clara con la foto enmarcada en un
   marco botánico fino (dorado), contador en serif rosa, dots y
   thumbnails con borde dorado/rosa activo. Copia el comportamiento de
   shared/Gallery: pre-carga de ratios, autoplay 5s con pausa en hover y
   transición ken-burns sutil (respetando prefers-reduced-motion).
------------------------------------------------------------------ */
      ...
      >
        ...
        <GoldFrame accent className="rounded-[1.6rem] p-2.5 md:rounded-[2rem] md:p-3">
          ...
          >
            ...
            <div className="pointer-events-none absolute inset-x-0 bottom-0 h-24 bg-gradient-to-t from-[#FDF1F5]/85 to-transparent" />

            {/* Contador en serif rosa */}
        ...
        {/* Thumbnails con borde dorado/rosa activo */}
        {images.length > 1 && (
