...
/* ------------------------------------------------------------------
   "Nota manuscrita" (XV de Alice): tarjeta blanca #FFFFFF con esquinas
   botánicas y sombra rosa suave, sobre fondo rosa pastel. Texto serif
   itálico grande. Misma paridad de null que shared/RegistryNote (sin
   título propio: el título de "Mesa de Regalos" lo aporta la sección
   Gifts que le sigue).
------------------------------------------------------------------ */
