...
/* ------------------------------------------------------------------
   Dress Code (XV de Alice): medallones finos con icono de línea dorada,
   anillo dorado y etiqueta serif; la nota se muestra como cita itálica
   centrada con floritura botánica. Copia los iconos SVG y la paridad de
   null de shared/DressCode (acepta array o string con saltos de línea).
------------------------------------------------------------------ */
