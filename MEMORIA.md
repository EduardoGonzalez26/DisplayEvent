...
> **Iteración del 2026-09-16 (incluida en el commit de esta fecha):** retiro del bloque de transferencia de la Mesa de Regalos, intro dinámica con el nombre de la quinceañera y textos fijos (galería, saludo familiar y portada). La iteración anterior (Padres/Padrinos, Mesa de Regalos informativa y bloqueo de scroll del sobre, §7) ya está commiteada (`a241198`; memoria en `61520ef`).
